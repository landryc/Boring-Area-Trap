...
class QLearning:
    ...
    def __init__(self, left_initial_mean=0., right_initial_mean=1., learning_rate=0.01, gamma=0.95,epsilon = 1.0, epsilon_decay=0.999, learning_rate_decay=0.5, epsilon_min=0):
